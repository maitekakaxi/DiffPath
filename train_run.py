...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='path', help='')
    ...
    parser.add_argument('--dataset_name', type=str, default='path', help='')
    parser.add_argument('--dataset_config_name', type=str, default='path', help='')
    parser.add_argument('--train_file', type=str, default='path', help='')
    parser.add_argument('--validation_file', type=str, default='path', help='')
